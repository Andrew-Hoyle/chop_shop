...
import drone_image from '../../assets/images/stockcar.jpg.jpg';
        ...
        <div className={classes.root}>
            <nav>
                <div className={classes.navbar_container}>
                    <h1 className={ `${classes.logo}`}>
                        <a href='#' className={`${classes.logo_a} ${classes.logo_navigation}`}>Your Local Chop Shop :)</a>
                    </h1>
            ...
            <main className={classes.main}>
                <div className={classes.main_text}>
                    <h1>{ props.title }</h1>
                    <p>Cars, Click go:</p>
                    <Button color="primary" variant="contained">Vroom</Button>
                </div>
